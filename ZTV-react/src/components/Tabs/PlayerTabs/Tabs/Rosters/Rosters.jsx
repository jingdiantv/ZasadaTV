        ...
        <div className="roster">
            ...
            <div className="teams_history">
                <div className="col_names">
                    {props.rosters !== null ? <p>Временной период</p> : <></>}
                    {props.rosters !== null ? <div className="col_names_team"><p>Команда</p></div> : <></>}
                    {props.rosters !== null ? <div className="col_names_trophies"><p>Трофеи</p></div> : <></>}
                </div>
